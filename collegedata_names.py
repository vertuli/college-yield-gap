...
school_rename_dict = {
	'Abraham Baldwin Agricultural College':np.nan,
	...
	'Cottey College':np.nan,
	"Crowley's Ridge College":np.nan,
	'DeVry University':"DeVry University - Chicago",
	'Dean College':np.nan,
	'Dunwoody College of Technology':np.nan,
	'East Georgia State College':np.nan,
	...
	'Gordon State College':np.nan,
	'Indian River State College':np.nan,
	...
	"Mount Saint Mary's University":"Mount St. Mary's University",
	...
	'SUNY College of Technology--Delhi':np.nan,
	...
	'University of Texas--Rio Grande Valley':np.nan,
